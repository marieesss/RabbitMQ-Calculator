...
def get_operations():
    ...
    approuved_operations = [{"key" : "addition", "routing_key": "operation.add"}, {"key" : "soustraction", "routing_key": "operation.sub"}, {"key" : "division", "routing_key": "operation.div"}, {"key" : "multiplication", "routing_key": "operation.mul"}]
